...
filename <- paste0('./../../Data/growth_dynamics/one_km_subset/drought_gpp_reduction_',Ecoregion,'.csv')
...
filename <- paste0('./../../Data/growth_dynamics/one_km_subset/drought_gpp_reduction_absolute_',Ecoregion,'.csv')
...
rm(gpp_predicted_average,gpp_predicted_drought,gpp_predicted_drought_average,
   ...
   gpp_predicted_drought_average_4,gpp_predicted_list_average,gpp_predicted_list_average_df,
   gpp_predicted_list_drought,gpp_reduction_list_2,gpp_predicted_list_drought_df,
   gpp_reduction_list,gpp_reduction_list_df,gpp_reduction_list_df_2,
   growth_drought_spline_list,growth_spline_list,ppt_gpp)
